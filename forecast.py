...
#dfplotmonth = dfplot.iloc[:,:][dfplot.Model == 'Actual'][sku]
st.write(dfplot.iloc[:,:][dfplot.Model == 'Actual'][sku])
...
month_plot(dfplot.iloc[:,:][dfplot.Model == 'Actual'][sku],dfplot.Date,ax=ax[1])
