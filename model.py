...
def Temperature():
    ...
    tempe = "33	34	35	35	35	34	33	32	32	33	32	32	34	34	35	35	36	34	33	33	33	31	32	32	32	32	35	34	34	33	33	33	32	32	32	32	33	34	34	34	33	34	32	33	32	32	32	32	33	33	34	34	34	33	33	32	32	32	32	32	32	33	34	34	34	33	33	32	32	32	32	32"
    tempe = tempe.split("\t")

    #data = {'Date': date,
    #      'max': tempe} 
    temperature = pd.DataFrame(tempe, columns=['max'],index=date)
    temperature['max'] = temperature['max'].astype('int64')
